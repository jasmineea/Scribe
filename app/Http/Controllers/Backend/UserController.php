...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $$module_name_singular->payment_intent = $request->password;
        ...
        if($request->customer_register==1){
            if ($request->wallet_balance) {
                $transaction = new Transaction;
                $transaction->user_id = $$module_name_singular->id;
            ...
            create_square_customer_id($$module_name_singular->first_name, $$module_name_singular->last_name, $$module_name_singular->email);
            event(new Registered($$module_name_singular));
            event(new UserRegistered($$module_name_singular));
