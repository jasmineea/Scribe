...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        'App\Events\Frontend\OrderPlaced' => [
            'App\Listeners\Frontend\SendOrderPlacedNotification'
        ],
        'App\Events\Frontend\WalletRecharge' => [
            'App\Listeners\Frontend\SendWalletRechargeNotification'
        ],
