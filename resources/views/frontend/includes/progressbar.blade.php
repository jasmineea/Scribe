<div class="tabbable">
    <ul class="nav cstm-nav-tabs wizard">
        ...
        <li class='{{"frontend.cards.step4"==request()->route()->getName()? "active" :"" }} {{in_array(request()->route()->getName(),["frontend.cards.step4","frontend.cards.step5","frontend.cards.step4b","frontend.cards.step4a"])? "filled active" :"" }}' id="confirm"><a href="{{ route("frontend.cards.step4b")}}" data-toggle="tab" aria-expanded="true"><span class="nmbr">5</span>Step 05</a></li>
